 ...
 */
#ifndef __VUSB_Keyboard_h__
#define __VUSB_Keyboard_h__
...
class VUSB_KeyboardDevice : public Print {
 public:
  VUSB_KeyboardDevice () {
    cli();
    usbDeviceDisconnect();
...
VUSB_KeyboardDevice VUSB_Keyboard = VUSB_KeyboardDevice();
...
extern "C"{
  ...
  // USB_PUBLIC uchar usbFunctionSetup
    ...
    usbMsgPtr = VUSB_Keyboard.reportBuffer; //
