...
#define VUSB_Joystick_DEFAULT_REPORT_INTERVAL 20
static unsigned char must_report = 0;
static unsigned char idle_rate = VUSB_Joystick_DEFAULT_REPORT_INTERVAL / 4; // in units of 4ms
...
VUSB_JoystickDevice VUSB_Joystick = VUSB_JoystickDevice();
