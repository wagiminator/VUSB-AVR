 ...
 */
#ifndef __VUSB_Mouse_h__
#define __VUSB_Mouse_h__
...
#define VUSB_Mouse_DEFAULT_REPORT_INTERVAL 20
static unsigned char must_report = 0;
static unsigned char idle_rate = VUSB_Mouse_DEFAULT_REPORT_INTERVAL / 4; // in units of 4ms
...
// create the global singleton VUSB_Mouse
VUSB_MouseDevice VUSB_Mouse = VUSB_MouseDevice();
